...
const KW = {
	hacks: 'Gray Zone Warfare cheats',
	cheats: 'Gray Zone Warfare cheats',
	hack: 'Gray Zone Warfare cheat',
	esp: 'gzw esp',
...
export const phrases = {
	es: {
		buy: 'Comprar Gray Zone Cheats', undetected: 'indetectables', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'Contacta support@grayzonecheats.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Gray Zone Cheats', undetected: 'indétectables', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'Contactez support@grayzonecheats.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Gray Zone Cheats kaufen', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Gray Zone Cheats', undetected: 'indetectáveis', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'Contacte support@grayzonecheats.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Gray Zone Cheats', undetected: 'indetectable', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'Contatta support@grayzonecheats.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'Gray Zone Cheats kopen', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Gray Zone Cheats satın al', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'Destek ve yasal sorular için support@grayzonecheats.net.',
	},
	ar: {
		buy: 'اشترِ Gray Zone Cheats', undetected: 'غير مكتشف', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Gray Zone Cheatsを購入', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'サポート・法務: support@grayzonecheats.net',
	},
	ko: {
		buy: 'Gray Zone Cheats 구매', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => '지원 및 법무: support@grayzonecheats.net',
	},
	zh: {
		buy: '购买 Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => '支持与法务：support@grayzonecheats.net',
	},
	hi: {
		buy: 'Gray Zone Cheats खरीदें', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'सहायता: support@grayzonecheats.net',
	},
	id: {
		buy: 'Beli Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Gray Zone Cheats', undetected: 'undetected', maps: 'Dam, Airfield, and Coastal zones',
		...
		legal: () => 'support@grayzonecheats.net för support och juridik.',
	},
};

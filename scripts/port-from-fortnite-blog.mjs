#!/usr/bin/env node
/**
 * Ports the 8 posts from ../gzw-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'gzw-blog', 'src', 'content', 'posts');
...
const file = `/* Auto-generated by scripts/port-from-gzw-blog.mjs — do not edit by hand. */

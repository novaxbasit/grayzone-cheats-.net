...
export const seoLandingPages = [
	{ label: fillBrandTokens('{game} hacks'), href: '/gzw-cheats/' },
	{ label: fillBrandTokens('{game} cheats'), href: '/gzw-cheats-2026/' },
	{ label: fillBrandTokens('{game} esp'), href: '/gzw-esp/' },
	{ label: fillBrandTokens('{game} aimbot'), href: '/gzw-aimbot/' },
	{ label: fillBrandTokens('{game} hack download'), href: '/gzw-cheat-download/' },
	{ label: fillBrandTokens('Undetected {primaryKeyword}'), href: '/undetected-gzw-cheats/' },
	{ label: fillBrandTokens('{game} wallhack'), href: '/gzw-wallhack/' },
	{ label: fillBrandTokens('{game} radar hack'), href: '/gzw-radar-hack/' },
] as const;

export const mainNav = [
	{ label: 'Home', href: '/' },
	{ label: 'Cheats', href: '/gzw-cheats/' },
	{ label: 'Aimbot', href: '/gzw-aimbot/' },
	{ label: 'ESP', href: '/gzw-esp/' },
...
export const footerExplore = [
	...
	{ label: fillBrandTokens('{game} hacks pillar'), href: '/gzw-cheats/' },
	{ label: fillBrandTokens('Undetected {game} hacks'), href: '/undetected-gzw-cheats/' },
	{ label: fillBrandTokens('{game} wallhack ESP'), href: '/gzw-wallhack/' },
	{ label: fillBrandTokens('{game} radar hack'), href: '/gzw-radar-hack/' },
	{ label: fillBrandTokens('{antiCheat} bypass guide'), href: '/eac-bypass/' },
	{ label: fillBrandTokens('{game} cheats 2026'), href: '/gzw-cheats-2026/' },
	{ label: fillBrandTokens('{game} Aimbot controls'), href: '/gzw-aimbot/' },
	{ label: fillBrandTokens('{game} ESP overlays'), href: '/gzw-esp/' },
...
export const homeFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		slug: 'are-gzw-cheats-undetected-in-2026',
	...
	faq({
		question: 'Does this work in PMC operations and bot encounters?',
		answer:
			'Yes. ESP, radar, and aimbot are built for {game} raid flow — reading PMCs and bots, spotting loot, and staying aware near extracts.',
		slug: 'pmc-raids-and-scav-runs',
		seoTitle: 'PMC Raid and bot Support | FAQ',
		seoDescription:
			'{brand} works in PMC operations and bot encounters — ESP, radar, and aimbot for Windows PC.',
	}),
	faq({
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'A {game} wallhack is an ESP overlay that shows PMCs, bots, and loot through walls. {brand} includes distance readouts, extract cues, and toggleable categories.',
		slug: 'what-is-a-gzw-wallhack',
		seoTitle: 'What Is a {game} Wallhack? | FAQ',
		seoDescription:
			'A {game} wallhack is ESP that reveals PMCs, bots, and loot through walls — with distance, extracts, and category toggles.',
	}),
	faq({
		...
		slug: 'does-gzw-cheats-include-radar-hack',
	...
	faq({
		...
		slug: 'eac-anti-cheat-and-gzw-cheats',
	...
	faq({
		...
		slug: 'buy-undetected-gzw-cheats-windows-pc',
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Gray Zone Cheats feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Gray Zone Cheats feels smooth on Customs.',
		slug: 'gzw-soft-aim-review-xkrypt0',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on bot encounters. You can see who is holding a hallway before you push. Still worth the price for Gray Zone Cheats.',
		short: 'ESP boxes help on bot encounters. Still worth the price for Gray Zone Cheats.',
		slug: 'gzw-esp-scav-run-review-buildsr4k',
		seoTitle: 'ESP Review by @buildsR4K — 4/5 | {brand}',
		seoDescription: '@buildsR4K rates {brand} ESP 4/5 for bot encounters on Windows PC.',
		date: '2026-07-19',
		tag: 'bot encounter',
	}),
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Gray Zone Cheats this wipe. Setup was simple. It stayed up after the last Easy Anti-Cheat update when my old cheat failed. Lifetime was a good buy.',
		short: 'Gray Zone Cheats stayed up after the last Easy Anti-Cheat update. Lifetime was a good buy.',
		slug: 'gzw-cloud-dma-review-dma-wizard',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Gray Zone Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Gray Zone Cheats is easy to tune on PC.',
		slug: 'gzw-controller-soft-aim-review-ctrl-player99',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Gray Zone Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
		short: 'ESP on Woods is solid. Support helped after a slow first launch.',
		slug: 'gzw-cheat-setup-review-stormchaser07',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Gray Zone Cheats pays for the monthly plan. Extract markers and distance make early raids faster.',
		short: 'Loot ESP in Gray Zone Cheats pays for the monthly plan.',
		slug: 'gzw-loot-esp-review-lootgoblinx',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Gray Zone Cheats since last wipe. Soft aim per weapon helps in dorms. Status updates after Easy Anti-Cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Gray Zone Cheats helps in dorms.',
		slug: 'gzw-soft-aim-raid-review-rankedgrind42',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Gray Zone Cheats saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Gray Zone Cheats saved me near extracts.',
		slug: 'gzw-radar-hack-review-vanlifeeft',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Gray Zone Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Gray Zone Cheats was back the next morning after a patch.',
		slug: 'gzw-eac-update-review-patchdaymike',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Gray Zone Cheats is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Gray Zone Cheats is excellent.',
		slug: 'gzw-sniper-soft-aim-review-snipezonly',
